	...
	this.addSkin=function() {
		...
		me.__97.logicBlock_visible = function() {
			...
			if (me.__97.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				else if (me.__97.ggCurrentLogicStateVisible == 2) {
					me.__97.style.visibility="hidden";
					me.__97.ggVisible=false;
				}
				else {
		...
		me.__99.appendChild(me._rectangle_1);
		me.__412.appendChild(me.__99);
		me.__98.appendChild(me.__412);
		...
		me.__123.onmouseover=function (e) {
			...
			me.__124.logicBlock_backgroundcolor();
		}
		...
		me.__124.logicBlock_backgroundcolor = function() {
			var newLogicStateBackgroundColor;
			if (
				((me.elementMouseOver['_123'] == true))
			)
			...
			if (me.__124.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				me.__124.ggCurrentLogicStateBackgroundColor = newLogicStateBackgroundColor;
				me.__124.style.transition='background-color 500ms ease 0ms';
				if (me.__124.ggCurrentLogicStateBackgroundColor == 0) {
					me.__124.style.backgroundColor="rgba(77,77,77,0.784314)";
				}
				else {
					me.__124.style.backgroundColor="rgba(255,255,255,0)";
				}
			}
		}
		me.__124.logicBlock_backgroundcolor();
		...
		me.__124.ggCurrentLogicStateBackgroundColor = -1;
		...
		me.__124.appendChild(me._image_1);
		me.__123.appendChild(me.__124);
		me.__98.appendChild(me.__123);
		...
		me.__93.logicBlock_position = function() {
			...
			if (me.__93.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__93.style.transition='left 1000ms ease 0ms, bottom 1000ms ease 0ms';
				if (me.__93.ggCurrentLogicStatePosition == 0) {
					me.__93.style.left = 'calc(50% - (100% / 2))';
					me.__93.style.bottom='120px';
				}
				else {
					me.__93.style.left='calc(50% - ((100% + 0px) / 2) + 0px)';
					me.__93.style.bottom='-200px';
				}
			}
		}
		...
		me.__95.appendChild(me._scrollarea_1);
		...
		me.__121.appendChild(me.__1_4);
		me.__94.appendChild(me.__121);
		...
		me.__120.logicBlock_backgroundcolor = function() {
			...
			if (me.__120.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				if (me.__120.ggCurrentLogicStateBackgroundColor == 0) {
					me.__120.style.backgroundColor="rgba(26,109,255,1)";
				}
				else {
					me.__120.style.backgroundColor="rgba(255,255,255,0.117647)";
				}
			}
		}
		...
		me.__1_3.appendChild(me.__120);
		me.__94.appendChild(me.__1_3);
		...
		me.__92.appendChild(me.__2_6);
		me._container_2.appendChild(me.__92);
		me.__91.appendChild(me._container_2);
		...
		me.__90.appendChild(me._image_7);
 ...
 let url = '';
  ...
  document.body.removeChild(textarea);
		...
		me._text_8.ggUpdateText=function() {
			var params = [];
			var hs = player._("www.hnb-cm.com", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me.__50.logicBlock_position = function() {
			...
			if (me.__50.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__50.style.transition='left 500ms ease 0ms, top 500ms ease 0ms';
				if (me.__50.ggCurrentLogicStatePosition == 0) {
					me.__50.style.left='0%';
					me.__50.style.top='0%';
				}
				else {
					me.__50.style.left='0%';
					me.__50.style.top='100%';
				}
			}
		}
		...
		me.__213.logicBlock_position = function() {
			...
			if (me.__213.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__213.ggCurrentLogicStatePosition == 0) {
					...
					me.__213.style.bottom='30px';
				}
				else {
					me.__213.style.left='calc(50% - ((100% + 0px) / 2) + 0px)';
					me.__213.style.bottom='60px';
				}
			}
		}
 ...
 let url = '';
  ...
  document.body.removeChild(textarea);
		...
		me.__.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player._(me.ggUserdata.description) == "\uc5f0\ub9bd\ud615D"))
			)
			{
				newLogicStateVisible = 0;
			}
	...
	function SkinCloner_cloner_1_Class(nodeId, parentScope, ggParent, parameter) {
		...
		me._nodeimage_11.appendChild(me.__96);
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		me.__60.logicBlock_size = function() {
			...
			if (me.__60.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me.__60.ggCurrentLogicStateSize == 0) {
					me.__60.style.width='115px';
					me.__60.style.height='25px';
					me.__60.style.left = 'calc(50% - (115px / 2))';
				...
				else if (me.__60.ggCurrentLogicStateSize == 3) {
					me.__60.style.width='60px';
					me.__60.style.height='25px';
					me.__60.style.left = 'calc(50% - (60px / 2))';
					skin.updateSize(me.__60);
		...
		me.__59.logicBlock_size = function() {
			...
			if (me.__59.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				else if (me.__59.ggCurrentLogicStateSize == 3) {
					me.__59.style.width='115px';
					me.__59.style.height='30px';
					me.__59.style.left = 'calc(50% - (115px / 2))';
					skin.updateSize(me.__59);
				}
				else {
